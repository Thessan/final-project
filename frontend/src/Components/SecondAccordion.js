...
export function SecondAccordion() {
    ...
    return (
        ...
        <Accordion
            ...
            <p className="small-header">PARTNER</p>
            <p>
            Are there prospective siblings at home? In that case, the risk of jealousy is imminent, especially if it is the first time he is going to have a sibling. The idea of ​​having to share your parents with someone else - someone who also cannot be seen, touched or played with - is not a completely uplifting thought. Children do not know that a heart only grows when it finds love and can actually hold as much as it wants! Do not assume that the child is as pep as you on the new little family member. Without listening, confirming and talking with love and empathy about all feelings - and tell them that you can not return a little sibling to BB, even if the suggestions are creative and honest on the part of the child. Jealousy is a natural part, but it can make the journey ahead easier to prepare and involve the older child already during pregnancy: sing the favorite songs for the stomach and tell that the child inside will recognize his big sibling's voice when it comes. Draw drawings, pat your stomach and feel for kicks. If possible, big brother or big sister can come with the midwife to listen to the heart sounds. If you are really daring, you can let the child choose the name… Once the baby has arrived, it can be good to ask relatives and friends who come and visit to say hello and talk to the big sibling first - and feel free to bring a small gift to the big baby to celebrate. A tip is to have some wrapped small gifts ready to present if forgotten.
            </p>
            <br></br>
